...
describe("validateSchema", () => {
  ...
  beforeEach(() => {
    ...
    schema = {
      ...
      CUSTOM: {
        required: false,
        type: "string",
        custom: (v: any) => v.length > 3 || "too short",
      },
  ...
  it("throws error for missing required variable in throw mode", () => {
    ...
    ).toThrow(/Environment variable "NODE_ENV" is required/);
  });
  ...
  it("validates number type correctly", () => {
    ...
    expect(() =>
      validateSchema(environment, { schema, validationMode: "throw" }),
    ).toThrow(/Environment variable "PORT" should be a number/);
  });
  ...
  it("validates boolean type correctly", () => {
    ...
    expect(() =>
      validateSchema(environment, { schema, validationMode: "throw" }),
    ).toThrow(/Environment variable "DEBUG" should be a boolean/);
  });
  ...
  it("validates email type correctly", () => {
    ...
    expect(() =>
      validateSchema(environment, { schema, validationMode: "throw" }),
    ).toThrow(/Environment variable "ADMIN_EMAIL" should be a valid email/);
  });
  ...
  it("validates URL type correctly", () => {
    ...
    expect(() =>
      validateSchema(environment, { schema, validationMode: "throw" }),
    ).toThrow(/Environment variable "WEBSITE" should be a valid URL/);
  });
  ...
  it("validates allowedValues correctly", () => {
    ...
    expect(() =>
      validateSchema(environment, { schema, validationMode: "throw" }),
    ).toThrow(/Environment variable "NODE_ENV" should be one of/);
  });
  ...
  it("validates custom function correctly", () => {
    ...
    expect(() =>
      validateSchema(environment, { schema, validationMode: "throw" }),
    ).toThrow(/Environment variable "CUSTOM": too short/);
  });
  ...
  it("validates regex correctly", () => {
    ...
    expect(() =>
      validateSchema(environment, { schema, validationMode: "throw" }),
    ).toThrow(/Environment variable "REGEX_TEST" does not match regex/);
  });
